...
# This script handles individual fruits in the game
# It manages their appearance, movement, and what happens when they're sliced

# Signal that will be emitted when a fruit is sliced
# This lets other scripts know when to update the score
signal fruit_sliced
